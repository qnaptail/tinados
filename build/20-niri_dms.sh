...
# Config
cp -avf "/ctx/rootfs/etc/skel/.config/niri/config.kdl" /etc/skel/.config/niri/config.kdl
cp -avf "/ctx/rootfs/etc/skel/.config/fuzzel" /etc/skel/.config/fuzzel
cp -avf "/ctx/rootfs/usr/share/xdg-desktop-portal/niri-portals.conf" /usr/share/xdg-desktop-portal/niri-portals.conf
